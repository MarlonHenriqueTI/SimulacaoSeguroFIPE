...
function consultarVeiculo($codreferencia,$tipoveiculo,$codmarca,$ano,$tipocombustivel,$anomodelo,$codmodelo){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://veiculos.fipe.org.br/api/veiculos/ConsultarValorComTodosParametros",
...
function consultarMarcas($codreferencia, $tipoveiculo){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://veiculos.fipe.org.br/api/veiculos/ConsultarMarcas",
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => "",
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 30,
...
function consultarModelos($codreferencia, $tipoveiculo, $codmarca){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://veiculos.fipe.org.br/api/veiculos/ConsultarModelos",
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => "",
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 30,
...
function consultarAnoModelo($codreferencia, $tipoveiculo, $codmarca, $codmodelo){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://veiculos.fipe.org.br/api/veiculos/ConsultarAnoModelo",
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => "",
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 30,
...
function consultarModeloAtravesAno($codreferencia, $tipoveiculo, $codmarca, $ano, $tipocombustivel, $anomodelo){
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://veiculos.fipe.org.br/api/veiculos/ConsultarModelosAtravesDoAno",
	  CURLOPT_RETURNTRANSFER => true,
	  CURLOPT_ENCODING => "",
	  CURLOPT_MAXREDIRS => 10,
	  CURLOPT_TIMEOUT => 30,
